...
<!-- para:0018 -->
We train linear probes on the model activations to be classifiers ([Belinkov, 2021](https://arxiv.org/abs/2102.12452)) using linear regression. For an input sequence x, let h^{(l)}(x) \in \mathbb{R}^{T \times d} denote the activations at layer l, where T is sequence length and d is the hidden dimension.
...
<!-- para:0096 -->
Auxiliary classifiers. Training auxiliary models for robustness has been explored by [Inan et al (2023)](https://arxiv.org/abs/2312.06674) and [Chi et al (2024)](https://arxiv.org/abs/2411.10414) with the LlamaGuard series of models. [Sharma et al (2025)](https://arxiv.org/abs/2501.18837) develop synthetic data pipelines for training robust classifiers and use large-scale red-teaming to validate the performance of their methods. Grey Swan have also recently used public jailbreaking challenges to validate the robustness of their LLM defences, combining short-circuiting and auxiliary classifiers. [Xie et al (2024)](https://arxiv.org/abs/2402.13494) also leverage model internals for classification though they use the pattern of gradients in the guarding model as the additional source of information. There’s also been previous work using multi-stage classifiers for detection such as [Yue et al (2023)](https://arxiv.org/abs/2310.03094)’s ‘Model Cascades’.

<!-- para:0097 -->
Robustness in the policy model. Rather than using auxiliary models, many previous approaches have tried to build robustness into the models itself, so that no monitoring cost is incurred. [Casper et al (2024)](https://arxiv.org/abs/2403.05030) and [Sheshadri et al (2024)](https://arxiv.org/abs/2407.15549) use latent adversarial training to improve robustness while [Zou et al (2024)](https://arxiv.org/abs/2406.04313) use short-circuiting to prevent jailbreaks from counteracting a model’s refusal circuits. Others have focused on finding attacks that beat these defences, including [Zou et al (2023)](https://arxiv.org/abs/2307.15043), [Jenner et al (2025)](https://arxiv.org/abs/2412.09565), while [Peng et al (2024)](https://arxiv.org/pdf/2411.07494) compare methods for quickly patching vulnerabilities in monitoring systems once they are discovered.

<!-- para:0098 -->
Probing for harmful outputs. Using linear probes on model activations has a long history going back at least to [Alain and Bengio (2016](https://arxiv.org/abs/1610.01644)). [Zou et al (2023)](https://arxiv.org/abs/2310.01405) and [Panickssery et al (2023)](https://www.lesswrong.com/posts/zt6hRsDE84HeBKh7E/reducing-sycophancy-and-improving-honesty-via-activation) use paired data to obtain vectors in activation space to control properties such as sycophancy and honesty. Many recent works have used sparse autoencoders (SAEs), as developed in [Bricken et al (2023)](https://transformer-circuits.pub/2023/monosemantic-features); [Cunningham et al (2023)](https://arxiv.org/abs/2309.08600), or dictionary learning ([Yun et al (2021)](https://arxiv.org/abs/2103.15949)), for unsupervised learning of vectors corresponding to semantic clusters, including many safety-relevant features (see [Templeton et al (2024)](https://transformer-circuits.pub/2024/scaling-monosemanticity)). [Bricken et al (2024)](https://transformer-circuits.pub/2024/features-as-classifiers/index.html) and [Kantamneni et al (2025)](https://arxiv.org/pdf/2502.1668) investigate the use of SAE latents as a tool for prediction using linear probing as a baseline, finding that linear probing as a baseline is difficult to beat, though SAEs can play a useful role in debugging the training datasets by detecting spurious correlations present in training datasets.
