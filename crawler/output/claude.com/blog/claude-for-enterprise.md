...
<!-- para:0002 -->
Teams with more context do better work. The Claude Enterprise plan offers an expanded 500K context window, more usage capacity, and a native Git Hub integration so you can work on entire codebases with Claude. It also includes enterprise-grade security features—like SSO, role-based permissions, and admin tooling—that help protect your data and team.
...
<!-- para:0010 -->
![Claude UI shown with the user uploading in several documents, csvs, and PDFs](https://cdn.prod.website-files.com/68a44d4040f98a4adf2207b6/68e95d92ba1aafbfffec25f5_13bdd665b8f4dfe5ad0357c7a482816c0f99ec08-1920x1080.png)

<!-- para:0011 -->
We’re also introducing a **native Git Hub integration** for engineering teams to sync Git Hub repositories with Claude. Now, you can work alongside your codebase to iterate on new features, debug issues, or onboard new engineers. Git Hub is the first of the native integrations we're building to connect Claude to your most important data sources, enabling Claude to provide more relevant and insightful assistance. This feature is available in beta for early Enterprise plan users today. We plan to make it more broadly available later this year.

<!-- para:0012 -->
![Claude UI where the user is selecting the Git Hub connector to add knowledge to a project](https://cdn.prod.website-files.com/68a44d4040f98a4adf2207b6/68e95d92ba1aafbfffec25eb_6bd0725018a71761a3eb8a206573f09b068ae9c5-1800x1200.png)
...
<!-- para:0014 -->
![Claude UI featuring a scatter plot artifact](https://cdn.prod.website-files.com/68a44d4040f98a4adf2207b6/68e95d92ba1aafbfffec25f9_a5c04aa8f6a125a2165956dcb1096c052dc2d777-3840x2160.png)

<!-- para:0015 -->
## Customer spotlights

<!-- para:0016 -->
Early customers like Git Lab and Midjourney have used Claude for Work across a variety of tasks and stages of work—from brainstorming, to streamlining internal processes to creating and translating content, to writing code. Claude collaborates with team members to create intentional outputs that unlock creativity, boost productivity, and expand what’s possible.

<!-- para:0017 -->
> Claude offers our team members a tool that feels like an extension of their work and expertise, allowing us to take on more complex tasks and deliver greater impact while ensuring Git Lab’s IP remains private and protected.

<!-- para:0018 -->
— Taylor Mc Caslin, Product Lead for AI and ML Tech, Git Lab
