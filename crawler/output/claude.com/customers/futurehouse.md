---
source_url: https://claude.com/customers/futurehouse
title: "Future House powers scientific discovery agents with Claude"
section: customers
---

<!-- para:0001 -->
# Future House powers scientific discovery agents with Claude

<!-- para:0002 -->
[Future House](https://platform.futurehouse.org/), a nonprofit advancing research automation, uses Claude to power a sophisticated ecosystem of AI agents that help scientists navigate complex literature, generate hypotheses, and accelerate the pace of biological discovery.

<!-- para:0003 -->
With Claude, Future House:
...
<!-- para:0020 -->
These agents operate within Future House's open-source "Aviary" environment, which coordinates their interaction with scientific tools and manages complex research workflows.
...
<!-- para:0027 -->
This expansion requires advanced multimodal AI capabilities, especially for understanding scientific graphs and processing experimental data. Future House plans to make their platform publicly accessible with usage limits for individual researchers, democratizing these powerful tools for scientists worldwide.
