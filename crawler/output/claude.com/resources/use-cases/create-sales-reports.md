...
- Share [Copy link](https://claude.com/resources/use-cases/create-sales-reports#)https://claude.com/resources/use-case/create-sales-reports
...
<!-- para:0006 -->
I need a Q4 sales report for our exec team meeting next week. Pull October through December from Hub Spot.
...
<!-- para:0011 -->
Connect your CRM using [connectors](https://claude.ai/settings/connectors) so Claude can pull current sales data directly, eliminating manual exports and ensuring the report reflects your latest metrics.

<!-- para:0012 -->
## Required context

<!-- para:0013 -->
In Settings > Capabilities, find and enable your [Hub Spot](https://mcp.hubspot.com/anthropic) connector. Once connected, Claude can read sales data and pull metrics on demand without you exporting files or copying data manually. Add any additional context your CRM doesn't capture to help Claude conduct analysis more tailored to your business.

<!-- para:0014 -->
## Optional context

<!-- para:0015 -->
Turn on [Extended Thinking](https://support.claude.com/en/articles/10574485-using-extended-thinking) so Claude can better reason through your analysis and create high quality outputs.
...
<!-- para:0018 -->
I pulled your Q4 data from Hub Spot and created a professional sales report. Here's what stands out:
...
<!-- para:0039 -->
Unlike uploaded CSV files (static snapshots), [connectors](https://claude.com/blog/what-is-model-context-protocol) allow Claude to access current data from your tools. Ask Claude to pull the latest Q4 data from Hub Spot whenever you need an update, and generate a report with the latest numbers without re-exporting files.
