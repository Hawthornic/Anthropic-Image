---
source_url: https://red.anthropic.com/2025/project-vend-2/
...
<!-- para:0009 -->
![Figure 1: Various changes to the setup of Project Vend seem to have stabilized and, eventually, improved its business performance. CRM = Claudius given access to Customer Relationship Management software; SF2 = second vending machine in San Francisco; NYC = vending machine opened in New York City; LON = vending machine opened in London. Note that although we refer to "phase two," which largely coincides with the introduction of the CEO and the other changes we discuss in this article, there is not a completely clean demarcation between phases; we continued to iterate on the architecture throughout.](https://red.anthropic.com/2025/project-vend-2/ProjectVend-Fig1.png)

<!-- para:0010 -->
![Figure 2: Profits made over time in Project Vend (combined across all locations). As the second phase progressed, weeks with negative profit margin were largely eliminated.](https://red.anthropic.com/2025/project-vend-2/ProjectVend-Fig2.png)
...
<!-- para:0014 -->
![Figure 3: The basic setup of the second phase of Project Vend. Some elements (like the CEO and Clothius) were entirely new while others (like web search and browser use) were improvements on the previous setup.](https://red.anthropic.com/2025/project-vend-2/ProjectVend-Fig3.png)
...
<!-- para:0059 -->
Not only was there a lot of interest in Clothius’s products, as you can see in the “top 15 products” data, but many of them made a decent profit, too. (That is, aside from the hats that had the “Vendings and Stuff” brand name on them, which were sold very cheap and we’re not entirely sure why). Remarkably, Clothius even found a way to make a profit from some, though not all, types of tungsten cube—this became markedly easier when Andon Labs [purchased a](https://x.com/andonlabs/status/1967751648182407342?s=20)[laser etching machine](https://x.com/andonlabs/status/1967751648182407342?s=20) so they could do the tungsten logo-writing in-house.

<!-- para:0060 -->
![Figure 4: The top 15 products sold across all the Project Vend vending machines. The left graph shows the numbers of products; the right graph shows the profit margin on each one.](https://red.anthropic.com/2025/project-vend-2/ProjectVend-Fig4.png)
...
<!-- para:0098 -->
Project Vend wouldn't exist without our partners at [Andon Labs](https://andonlabs.com/), who built the hardware and software infrastructure behind the operation and kept our fridges and shelves s[tocked. We’re also very grateful to Keir Bradwell and Allison Lattanzio for doing the same in their respective offices, and to Amritha Kini and Ryan O’Holleran for some sales advice.

<!-- para:0099 -->
This blog is cross-posted from the main Anthropic [website](https://www.anthropic.com/research/project-vend-2).

<!-- para:0100 -->
### Footnotes

<!-- para:0101 -->
[[1]](https://red.anthropic.com/2025/project-vend-2/#ftnt_ref1) That is, similar to phase one, we didn’t add any new sophisticated guardrails or classifiers to defend against jailbreaks.

<!-- para:0102 -->
[[2]](https://red.anthropic.com/2025/project-vend-2/#ftnt_ref2) This might remind some readers of our discussion of the “spiritual bliss attractor state” from the [Claude 4 system card](https://www.anthropic.com/claude-4-system-card) (p. 63).
