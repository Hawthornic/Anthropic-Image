---
source_url: https://red.anthropic.com/2025/project-vend/index.html
...
<!-- para:0001 -->
#### Anthropic (with [Andon Labs](https://andonlabs.com/))

<!-- para:0002 -->
June 27, 2025

<!-- para:0003 -->
This blog post is cross-posted from the main Anthropic [website](https://www.anthropic.com/research/project-vend-1).
...
<!-- para:0006 -->
Anthropic partnered with [Andon Labs](https://andonlabs.com/), an AI safety evaluation company, to have Claude Sonnet 3.7 operate a small, automated store in the Anthropic office in San Francisco. Here is an excerpt of the system prompt—the set of instructions given to Claude—that we used for the project:
...
<!-- para:0017 -->
If Anthropic were deciding today to expand into the in-office vending market,^[[2]](https://red.anthropic.com/2025/project-vend/index.html#ftnt2)^ we would not hire Claudius. As we’ll explain, it made too many mistakes to run the shop successfully. However, at least for most of the ways it failed, we think there are clear paths to improvement—some related to how we set up the model for this task and some from rapid improvement of general model intelligence.
...
<!-- para:0042 -->
[[1]](https://red.anthropic.com/2025/project-vend/index.html#ftnt_ref1) “Vibe coding” refers to a trend in which software developers–some with minimal experience–describe coding projects in natural language and allow AI to handle the detailed implementation.

<!-- para:0043 -->
[[2]](https://red.anthropic.com/2025/project-vend/index.html#ftnt_ref2) We are not.

<!-- para:0044 -->
[[3]](https://red.anthropic.com/2025/project-vend/index.html#ftnt_ref3) Thomas Kwa et al., "Measuring AI Ability to Complete Long Tasks" (2025), arXiv:2503.14499, [https://arxiv.org/abs/2503.14499](https://arxiv.org/abs/2503.14499).

<!-- para:0045 -->
[[4]](https://red.anthropic.com/2025/project-vend/index.html#ftnt_ref4) Beyond the weirdness of an AI system selling cubes of metal out of a refrigerator.

<!-- para:0046 -->
[[5]](https://red.anthropic.com/2025/project-vend/index.html#ftnt_ref5) It is worth clarifying that Claudius was told it was a digital agent in its system prompt.

<!-- para:0047 -->
[[6]](https://red.anthropic.com/2025/project-vend/index.html#ftnt_ref6) For example, see the section on “high-agency behavior” beginning on p.44 of the [Claude 4 system card](https://www-cdn.anthropic.com/6be99a52cb68eb70eb9572b4cafad13df32ed995.pdf).
