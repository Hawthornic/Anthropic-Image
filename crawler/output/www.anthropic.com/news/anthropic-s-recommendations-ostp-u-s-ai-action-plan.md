...
<!-- para:0002 -->
As our CEO Dario Amodei writes in ‘[Machines of Loving Grace](https://darioamodei.com/machines-of-loving-grace)’, we expect powerful AI systems will emerge in late 2026 or early 2027. Powerful AI systems will have the following properties:
...
<!-- para:0004 -->
Our own recent work adds further evidence to the idea that powerful AI will arrive soon: our recently-released [Claude 3.7 Sonnet and Claude Code](https://www.anthropic.com/news/claude-3-7-sonnet) demonstrate significant capability improvements and increased autonomy, as do systems released by other frontier labs.
