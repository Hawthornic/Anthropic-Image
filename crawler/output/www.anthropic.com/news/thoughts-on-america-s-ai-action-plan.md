...
<!-- para:0004 -->
We applaud the Administration's commitment to streamlining data center and energy permitting to address AI’s power needs. As we stated in our OSTP submission and at [the Pennsylvania Energy and Innovation Summit](https://www.youtube.com/watch?v=KO8vMSsjmGY), without adequate domestic energy capacity, American AI developers may be forced to relocate operations overseas, potentially exposing sensitive technology to foreign adversaries. Our recently published [“Build AI in America” report](https://www-cdn.anthropic.com/0dc382a2086f6a054eeb17e8a531bd9625b8e6e5.pdf) details the steps the Administration can take to accelerate the buildout of our nation’s AI infrastructure, and we look forward to working with the Administration on measures to expand domestic energy capacity.
...
<!-- para:0009 -->
The Action Plan’s continuation of the National AI Research Resource (NAIRR) pilot ensures that students and researchers across the country can participate in and contribute to the advancement of the AI frontier. We have [long supported](https://nsf-gov-resources.nsf.gov/files/Anthropic-NAIRR-RFI-Response-2022.pdf?VersionId=zOuWKBYCI5lsNESyOvsZIJQM9ePTOTrK) the NAIRR and are proud of [our partnership](https://www.nsf.gov/focus-areas/artificial-intelligence/nairr#nairr-pilot-partners-and-contributors-890) with the pilot program. Further, the Action Plan’s emphasis on rapid retraining programs for displaced workers and pre-apprenticeship AI programs recognizes the errors of prior technological transitions and demonstrates a commitment to delivering AI’s benefits to all Americans.

<!-- para:0010 -->
Complementing these proposals are our efforts to understand how AI is transforming, and how it will transform, our economy. The [Economic Index](https://www.anthropic.com/economic-index) and the [Economic Futures Program](https://www.anthropic.com/economic-futures) aim to provide researchers and policymakers with the data and tools they need to ensure AI’s economic benefits are broadly shared and risks are appropriately managed.

<!-- para:0011 -->
## **Promoting secure AI development**

<!-- para:0012 -->
[Powerful AI systems](https://www.darioamodei.com/essay/machines-of-loving-grace) are going to be developed in the coming years. The plan’s emphasis on defending against the misuse of powerful AI models and preparing for future AI related risks is appropriate and excellent. In particular, we commend the administration’s prioritization of supporting research into [AI interpretability](https://www.darioamodei.com/post/the-urgency-of-interpretability), AI control systems, and adversarial robustness. These are important lines of research that must be supported to help us deal with powerful AI systems.

<!-- para:0013 -->
We're glad the Action Plan affirms the National Institute of Standards and Technology's Center for AI Standards and Innovation’s (CAISI) important work to evaluate frontier models for national security issues and we look forward to continuing our close partnership with them. We encourage the Administration to continue to invest in CAISI. As we noted in our submission, advanced AI systems are demonstrating concerning improvements in capabilities relevant to biological weapons development. CAISI has played a leading role in developing testing and evaluation capabilities to address these risks. We encourage focusing these efforts on the most unique and acute national securityrisks that AI systems may pose.

<!-- para:0014 -->
## **The need for a national standard**

<!-- para:0015 -->
Beyond testing, we believe basic AI development transparency requirements, such as public reporting on safety testing and capability assessments, are essential for responsible AI development. Leading AI model developers should be held to basic and publicly-verifiable standards of assessing and managing the catastrophic risks posed by their systems. Our [proposed framework](https://www-cdn.anthropic.com/19cc4bf9eb6a94f9762ac67368f3322cf82b09fe.pdf) for frontier model transparency focuses on these risks. We would have liked to see the report do more on this topic.

<!-- para:0016 -->
Leading labs, including Anthropic, OpenAI, and Google DeepMind, have already implemented voluntary safety frameworks, which demonstrates that responsible development and innovation can coexist. In fact, with the launch of Claude Opus 4, we proactively [activated ASL-3 protections](https://www.anthropic.com/news/activating-asl3-protections) to prevent misuse for chemical, biological, radiological, and nuclear (CBRN) weapons development. This precautionary step shows that far from slowing innovation, robust safety protections help us build better, more reliable systems.

<!-- para:0017 -->
We share the Administration’s concern about overly-prescriptive regulatory approaches creating an [inconsistent and burdensome patchwork of laws](https://www.nytimes.com/2025/06/05/opinion/anthropic-ceo-regulate-transparency.html). Ideally, these transparency requirements would come from the government by way of a single national standard. However, in line with our [stated belief](https://www.nytimes.com/2025/06/05/opinion/anthropic-ceo-regulate-transparency.html) that a ten-year moratorium on state AI laws is too blunt an instrument, we continue to oppose proposals aimed at preventing states from enacting measures to protect their citizens from potential harms caused by powerful AI systems, if the federal government fails to act.
