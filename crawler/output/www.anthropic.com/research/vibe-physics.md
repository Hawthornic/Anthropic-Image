...
<!-- para:0020 -->
- Only give text prompts to [Claude Code](https://claude.ai/redirect/website.v1.52cdad0c-ca7a-43d0-8297-e3f64b8a4f36/code). No editing files directly.
...
<!-- para:0024 -->
From there, I turned to [Claude Code](https://claude.ai/redirect/website.v1.52cdad0c-ca7a-43d0-8297-e3f64b8a4f36/code), using the extension in VS Code.
